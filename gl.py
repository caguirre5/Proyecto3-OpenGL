...
class Renderer(object):
    def __init__(self, screen, r, g, b):
        self.r = r
        self.g = g
        self.b = b
    ...
    def render(self):
        glClearColor(self.r, self.g, self.b, 0)
        ...
        if self.active_shader is not None:
            ...
            glUniform1f(glGetUniformLocation(
                self.active_shader, "time"), self.time)

            glUniform3fv(glGetUniformLocation(self.active_shader,
                         "pointLight"), 1, glm.value_ptr(self.pointLight))
